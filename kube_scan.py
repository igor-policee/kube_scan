...
def get_pod_security_contexts_and_parameters(namespace, kube_config, prefix):
    ...
    for pod in pods.items:
        if str.startswith(pod.metadata.name, f"{prefix}"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prefix", required=True, help="The POD prefix to inspect.")
    args = parser.parse_args()

    get_pod_security_contexts_and_parameters(args.namespace, args.kubeconfig, args.prefix)